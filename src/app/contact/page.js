        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            ...
            <div>
              ...
              {formStatus && (
                <div className={`p-4 mb-4 rounded-lg ${formStatus.type === "success" ? "bg-green-100 text-green-800 dark:bg-green-800/20 dark:text-green-400" : "bg-red-100 text-red-800 dark:bg-red-800/20 dark:text-red-400"}`}>
                  {formStatus.message}
                </div>
              )}
